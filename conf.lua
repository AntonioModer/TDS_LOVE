...
function love.conf(argC)
	...
	argC.window.width = 2560
	argC.window.height = 1440
	argC.window.borderless = false                                                                                                              -- Remove all border visuals from the window
	argC.window.resizable = true                                                                                                               -- Let the window be user-resizable
	argC.window.minwidth = 1280                                                                                                                 -- Minimum window width if the window is resizable
	argC.window.minheight = 720                                                                                                                 -- Minimum window height if the window is resizable
	argC.window.fullscreen = false
	argC.window.fullscreentype = "desktop"                                                                                                      -- "desktop" or "exclusive"
...
--	argC.window.y = 6320                                                                                                                        -- убираем окно, чтобы не закрывало экран
	...
	config.controls.player.visZone = false           -- туман видимости
	config.controls.ui = {}
