...
ThisModule.image = ThisModule._modGraph.images.woodPlanks["_" .. tostring(ThisModule._variation)]
...
function ThisModule:setVariation(argNumber, variant)
	...
	if variant == 1 or variant == nil then
		...
		if type(argNumber) == 'number' then
			...
			self.image = ThisModule._modGraph.images.woodPlanks["_" .. tostring(self._variation)]
		end
