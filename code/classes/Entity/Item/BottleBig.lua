...
ThisModule.image = ThisModule._modGraph.images.bottles.big["_" .. tostring(ThisModule._variation)]
ThisModule.shadows = {}
...
ThisModule.shadows.directional.z = 1
...
--	object.physics.body:setAngularDamping(0)
	...
	if arg == nil or arg.physics == nil or (arg.physics and not arg.physics.dontCreateFixtures) then
		...
		object.physics.fixtureDefaultCategories = {4}      -- 4
		object.physics.fixtureDefaultMasks = {}           -- 3
		fixture:setCategory(unpack(object.physics.fixtureDefaultCategories))
		fixture:setMask(unpack(object.physics.fixtureDefaultMasks))
...
function ThisModule:setVariation(argNumber, variant)
	...
	if variant == 1 or variant == nil then
		...
		if type(argNumber) == 'number' then
			...
			self.image = ThisModule._modGraph.images.bottles.big["_" .. tostring(self._variation)]
		end
