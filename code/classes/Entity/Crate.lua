...
ThisModule.image = ThisModule._modGraph.images.crates["_" .. tostring(ThisModule._variation)]
...
--	fixture:setSensor(true)
	...
	fixture:setUserData({typeDraw = true, itemCanRestOnMe = true})
...
function ThisModule:setVariation(argNumber, variant)
	...
	if variant == 1 or variant == nil then
		...
		if type(argNumber) == 'number' then
			...
			self.image = ThisModule._modGraph.images.crates["_" .. tostring(self._variation)]
		end
