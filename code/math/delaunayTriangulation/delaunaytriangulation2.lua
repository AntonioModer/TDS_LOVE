...
function CreateBoundingTriangle( vertices )
	...
	local dx = ( maxx - minx ) * 1000										-- < * ...>: чем больше множитель, тем выпуклее будет фигура, а если его нет, то фигура будет вогнутая
	local dy = ( maxy - miny ) * 1000
...
return {Vertex=Vertex, Triangulate=Triangulate}